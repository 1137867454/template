<template>
  <div id="header" class="refuseCopy relative">
      ...
      <el-menu
        style="padding-left: 16%; height:42px;"
      ...
      <div class="removeItem">
        <el-dropdown>
          <span style="display:inline-block;padding:0 10px;margin-right:10px;color:#fff;background:rgba(100,100,100,0.6);" class="el-dropdown-link">
            Hi,管理员
            <!-- <img
              class="headPhoto"
