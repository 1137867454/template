...
import eg1 from '../views/example/eg1'
export const asyncRouterMap = [{
  path: '/example',
  name: 'example',
  component: Home,
  meta: { title: '普通用户', icon: 'el-icon-guide el' },
  menu: ['user'],
  children: [{
    path: 'eg1',
    name: 'eg1',
  ...
  },
  {
    path: 'eg2',
    name: 'eg2',
    component: () => import("../views/example/eg2"),
  ...
  },
  {
    path: 'star',
    name: 'star',
    component: () => import("../views/example/star"),
    meta: { title: '星星', icon: 'el-icon-edit el'},
    menu: ['user']
  }]
},
  {
    ...
    name: 'admin',
    component: Home,
    meta: { title: '管理员', icon: 'el-icon-guide el' },
    menu: ['admin'],
    children: [{
      path: 'eg1',
      name: 'eg1',
