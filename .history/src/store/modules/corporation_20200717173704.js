...
const corporation = {
  ...
  getters: {
    ...
    get_AttendenceList: state => state.attendenceList,
  ...
  mutations: {
    ...
    set_GetAttendence: (state, data) => state.attendenceList = data,
    // treeMenu() {
   ...
   */
    ...
    */
    ...
    deleteAttendence({dispatch}, data) {
    ...
    updateAttendence({dispatch}, data) {
    ...
    getAttendenceList({commit, dispatch}, page) {
      ...
      fx.setConnect({url})
      .then(res => {
        commit(set_GetAttendence, res.data.data)
      }).catch(err => {
