<template>
  <div class="star relative height_100">
    ...
    <div class="flexLayout">
        ...
        <img :class="[{'scale': scaleI == i}, 'headPhoto', 'images']"
         v-for="(v, i) in image" @click="scale(i)" :key="i" src="../../assets/img/3.jpg">
    ...
    <video ref="mediaVideo" src=""></video>
    <!-- <div class="light"></div>
    <div class="box"></div>
    <img class="images" src="../../assets/img/1.jpg" style=""> -->
  </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    .then(mediaStream => {
      this.$refs['mediaVideo'].src = mediaStream
    })
    this.$refs['mediaVideo'].src = ''
    console.log(this.$refs['mediaVideo'].src)
...
.light{
  ...
  margin:0 auto;
  background:#fff;  
  box-shadow: 0 0 20px #ff0 ,inset 0 0 40px 10px #ff0;
