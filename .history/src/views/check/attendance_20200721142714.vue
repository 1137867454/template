<template>
  <div class="height_100 attendance">
    ...
    <!-- <el-select @change="corporationChange" clearable
      ...
      :autofocus="true" @clearable="selectName"
       v-model="page.corporationName" filterable
    ...
    <el-select  clearable
      style="width:180px;margin-right:10px;" size="small"
      :autofocus="true" @clearable="selectName"
       v-model="page.departmentName" filterable
        placeholder="请选择部门所属公司">
    <el-option
      v-for="item in get_DepartmentList.records"
      :key="item.id"
      :label="item.name"
      :value="item.id">
    </el-option>
  ...
  <el-input size="small" v-model="page.corporationName"
      @keydown.enter.native="selectName" clearable
      @clear="selectName" placeholder="请选择公司"
    style="width:180px;margin-right:10px;"></el-input>
  <el-input size="small" v-model="page.departmentName"
      @keydown.enter.native="selectName" clearable
      @clear="selectName" placeholder="请选择部门所属公司"
    style="width:180px;margin-right:10px;"></el-input>
  <!-- {{permissionArr}} -->
  <span style="display:inline-block;margin-right:10px;" v-show="permissionArr.includes('view')">
      ...
      @keydown.enter.native="selectName" clearable
      @clear="selectName" placeholder="考勤名目"
    style="width:180px;margin-right:10px;"></el-input>
  </span>
    <el-date-picker size="small"
      v-model="page.startTime"
      style="width:340px;" format="yyyy-MM-dd HH:mm"
