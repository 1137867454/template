<template>
  <div class="height_100 department">
    ...
    <el-button style="margin-left:10px" size="small" @click="dialogVisible = true"><i class="el-icon-document-copy" /> 模板</el-button>
    <el-dialog
      title="员工信息导入"
      ...
      :file-list="fileList">
      <el-button style="margin-left:10px" size="small" @click.stop=""><router-link to="/"><i class="el-icon-document-copy" /> 模板下载</router-link></el-button>
