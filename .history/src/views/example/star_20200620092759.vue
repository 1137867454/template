<template>
  <div class="star relative">
    ...
    <div>
        ...
        <img :class="[{'scale': scaleI == i}, 'headPhoto']" v-for="(v, i) in 10" @click="scale(i)" :key="i" src="../../assets/img/3.jpg">
    </div>
    ...
    <img :class="[{'rotate':animationVisible},'loading']"
     src="../../assets/img/loading.png">
    <el-button @click.prevent="animationStar">动画开始</el-button>
    <el-button>人物 动画开始</el-button>
    <button></button>
  </div>
</template>
