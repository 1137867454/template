<template>
  <div id="login_2" class="animate__animated animate__fadeIn">
    <div class="dowebok">
          ...
          <el-form
            ...
            <el-form-item class="form-item" prop="username">
              ...
              <el-form-item class="form-item" prop="password">
                <input :placeholder="$t('m.placeholder.username')"
                  id="password"
                  style="background-color:transparent !important;"
          ...
          <el-input size="small" style="width:200px;" v-model="form.f" placeholder="$t('m.placeholder.username')"></el-input>
          <!-- <div class="form-item">
          ...
          <div class="form-item"><button id="submit" @click="login('form')"><i v-if="loginStatus" class="el-icon-loading"></i>{{ $t('m.login.button') }}</button></div>
          <!-- <div class="reg-bar">
