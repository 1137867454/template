<template>
  <div class="height_100 eg1">
    <div class="buttonGroup" v-if="addVisible">
		...
		<el-button type="success" @click="addVisible=false;" size="small">
			...
			添加</el-button>
		<el-button type="warning" @click="addVisible=false;" size="small">
  ...
  <el-card v-show="!addVisible" class="box-card" style="height:80%;">
  <!-- <div v-for="o in 4" :key="o" class="text item">
    {{'列表内容 ' + o }}
  </div> -->
  <div slot="header" class="clearfix">
    <span v-text="!addVisible" style="color:#0c6">账号添加</span>
