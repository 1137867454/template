 ...
 <div class="height_100 attendance">
  ...
  <!-- 日期选择 -->
    <el-date-picker size="small"
      ...
      style="width:350px;margin-right:10px;" format="yyyy-MM-dd HH:mm:ss"
...
export default {
  ...
  methods:{
            ...
            // 绘制图表
            this.$store.dispatch('getECharts').then(res => {
              // console.log('CCC'+JSON.stringify(res.data.data));
  ...
  mounted() {
   ...
   this.permissionArr = this.$route.meta.arr;
    // this.$store.dispatch('getECharts',this.name);
  }
}
</script>
